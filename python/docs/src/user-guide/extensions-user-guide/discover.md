...
| [autogen-hiveexchange](https://github.com/srotzin/hiveexchange-service) | — | Prediction markets and A2A trading for AutoGen agents. 233 markets, 6 autonomous Genesis agents, ZK solvency, x402 pay-per-call. |
